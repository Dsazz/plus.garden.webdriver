...
Browser.prototype = {
    ...
    waitForElementPresent: function (cssSelector, timeout, next) {
        ...
        this.driver.wait(function () {
            ...
            this.chai.assert(false, err.message);
            next();
        }.bind(this));
    },
    ...
    scrollToElement: function (cssSelector, next) {
        this.waitForElementPresent(cssSelector).then(function () {
            this.getElement(cssSelector).then(function (element) {
                this.driver.executeScript("arguments[0].scrollIntoView(true);", element).then(next);
            }.bind(this));
        }.bind(this));
    },
